...
const controlClassName =
  "w-full min-w-0 px-[calc(14*var(--unit))] py-[calc(12*var(--unit))] border border-[#3a3b39] rounded-[calc(4*var(--unit))] bg-[#131413] text-[#f0f0f1] [font:inherit] text-[calc(13*var(--unit))] focus-visible:outline-2 focus-visible:outline-vexiom-yellow focus-visible:outline-offset-2 disabled:cursor-not-allowed disabled:opacity-60 aria-[invalid=true]:border-[#b85c5c]"

const submitButtonClassName =
  "relative isolate inline-flex items-center justify-center gap-[calc(28*var(--unit))] h-[calc(49*var(--unit))] text-[calc(14*var(--unit))] font-[750] tracking-[-0.035em] [@media(max-width:650px)]:h-[46px] [@media(max-width:650px)]:text-[11px] [@media(max-width:650px)]:gap-[14px] [@media(max-width:360px)]:text-[10px] [@media(max-width:360px)]:gap-[10px] w-[calc(251*var(--unit))] text-[#111] before:content-[''] before:absolute before:inset-0 before:z-[-2] before:[clip-path:polygon(8%_0,100%_0,92%_100%,0_100%)] before:bg-[linear-gradient(110deg,#ffe414,#ffdd09)] hover:before:bg-[#ffed4c] [@media(max-width:650px)]:w-[58%] self-start mt-[calc(10*var(--unit))] border-none cursor-pointer focus-visible:outline-2 focus-visible:outline-vexiom-yellow focus-visible:outline-offset-4 disabled:cursor-not-allowed disabled:opacity-60"
